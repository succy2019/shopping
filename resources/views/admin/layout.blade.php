    ...
    <div class="d-flex">
        ...
        {{-- <nav class="sidebar d-none d-md-block">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-3">
                    <a class="nav-link text-white fw-bold" href="{{ route('admin.NewAdmin') }}">
                        <i class="fas fa-users"></i> New Administrators
                    </a>
                </li>
                <li class="nav-item mb-3">
                    <a class="nav-link text-white fw-bold" href="{{ route('user.profile') }}">
                        <i class="fas fa-users"></i>User Profile
                    </a>
                </li>
                {{-- <li class="nav-item">
        ...
        {{-- <nav class="sidebar-collapsed d-md-none">
            ...
            <a href="{{ route('user.profile') }}" title="Profile"><i class="fas fa-users fa-2x"></i></a>
            <a href="{{ route('admin.NewAdmin') }}" title="New Administrators"><i class="fas fa-users fa-2x"></i></a>
        </nav> --}}
